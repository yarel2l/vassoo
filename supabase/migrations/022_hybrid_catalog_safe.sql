-- ============================================
-- Migration: 022_hybrid_catalog (Safe Version)
-- Description: Hybrid catalog model - store custom products with approval workflow
-- NOTE: Use DROP IF EXISTS for idempotent execution
-- ============================================
...
DROP TRIGGER IF EXISTS update_store_custom_products_updated_at ON store_custom_products;
DROP TRIGGER IF EXISTS set_custom_product_submitted_at ON store_custom_products;
DROP TRIGGER IF EXISTS check_custom_product_availability ON store_custom_products;
DROP TRIGGER IF EXISTS track_custom_product_approval ON store_custom_products;
...
DROP POLICY IF EXISTS "Store members can view custom products" ON store_custom_products;
DROP POLICY IF EXISTS "Store managers can create custom products" ON store_custom_products;
DROP POLICY IF EXISTS "Store managers can update custom products" ON store_custom_products;
DROP POLICY IF EXISTS "Store owners can delete draft products" ON store_custom_products;
DROP POLICY IF EXISTS "Platform admins full access to custom products" ON store_custom_products;
DROP POLICY IF EXISTS "Store members can view approval history" ON product_approval_history;
DROP POLICY IF EXISTS "Platform admins full access to approval history" ON product_approval_history;
